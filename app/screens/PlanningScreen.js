...
// function saveData(tasks){
	...
	if(sync){
		...
		planning = tasks;
		//
		actallySaveTheData(planning, doc(firestore, "Planning", "TestDay"));
		actallySaveTheData(tasks   , doc(firestore, "Agenda"  , "TestDay"));
	}
}
...
// function saveData(tasks){
	...
	if(sync){
		...
		gaps = findGaps(tasks2);
		planning = PlanOut(gaps, todo_tasks);
